...
class _DriftUploadDetailPageState extends ConsumerState<DriftUploadDetailPage> {
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildBuilderDelegate((context, index) {
                ...
                return Padding(padding: const .only(bottom: 8), child: _buildErrorCard(context, item));
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(
            title,
            style: context.textTheme.titleSmall?.copyWith(fontWeight: .w600, color: color),
          ),
          ...
          count != null
              ? Container(
                  ...
                  child: Text(
                    count.toString(),
                    style: context.textTheme.labelSmall?.copyWith(fontWeight: .bold, color: color),
                  ),
                )
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Text(
                ...
                textAlign: .right,
                style: context.textTheme.titleMedium?.copyWith(fontWeight: .bold, color: context.colorScheme.tertiary),
              ),
            ),
          ],
        ),
  ...
  Widget _buildPlaceholderCard(BuildContext context) {
    return Card(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: const .all(.circular(12)),
        side: BorderSide(color: context.colorScheme.outline.withValues(alpha: 0.1), width: 1, style: .solid),
      ),
      child: Padding(
        padding: const .all(12),
        child: SizedBox(
        ...
        return SizedBox(
          ...
          child: Container(
            ...
            child: snapshot.data != null
                ? Thumbnail.fromAsset(asset: snapshot.data!, size: const Size(48, 48), fit: .cover)
        ...
        children: [
          ...
          Expanded(
            child: Text(
              ...
              style: context.textTheme.titleMedium?.copyWith(fontWeight: .w600, color: context.primaryColor),
            ),
          ),
        ],
      ),
                  ...
                  Center(
                    child: ClipRRect(
                      ...
                      child: Container(
                        ...
                        child: asset != null
                            ? Thumbnail.fromAsset(asset: asset, size: const Size(128, 128), fit: .cover)
                            : null,
                      ),
                    ),
                  ),
  ...
  Widget _buildInfoSection(BuildContext context, List<Widget> children) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: const .all(.circular(12)),
        border: .all(color: context.colorScheme.outline.withValues(alpha: 0.1), width: 1),
      ),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(value, style: context.textTheme.labelMedium, maxLines: 3, overflow: .ellipsis),
          ),
        ],
      ),
    );
