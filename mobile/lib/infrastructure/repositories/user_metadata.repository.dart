...
extension UserMetadataDataExtension on UserMetadataEntityData {
  UserMetadata toDto() => switch (key) {
    .onboarding => .new(userId: userId, key: key, onboarding: Onboarding.fromMap(value)),
    .preferences => .new(userId: userId, key: key, preferences: Preferences.fromMap(value)),
    .license => .new(userId: userId, key: key, license: License.fromMap(value)),
  };
}
